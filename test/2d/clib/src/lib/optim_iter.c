...
void matrix_mul_shift_noloop_a2(int *m_out, const int *m_in){
	...
	m_out[4] =  + m_in[2];
	m_out[5] =  + m_in[3];
	m_out[6] =  + m_in[3] + m_in[4] + m_in[5];
	m_out[7] =  + m_in[3] - m_in[4] + m_in[5];
	m_out[8] =  + m_in[3] + (m_in[4] << 1) + (m_in[5] << 2);
	m_out[9] =  + m_in[5];
	m_out[10] =  + m_in[6];
	m_out[11] =  + m_in[6] + m_in[7] + m_in[8];
	m_out[12] =  + m_in[6] - m_in[7] + m_in[8];
	m_out[13] =  + m_in[6] + (m_in[7] << 1) + (m_in[8] << 2);
	m_out[14] =  + m_in[8];
}
