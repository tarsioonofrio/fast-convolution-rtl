...
module MuxMult
  ...
  always_comb begin
    unique case (idx_in)
      ...
      MULT1: begin idx_out[0]=18; idx_out[1]=19; idx_out[2]=20; idx_out[3]=21; idx_out[4]=22; idx_out[5]=23; idx_out[6]=24; idx_out[7]=25; idx_out[8]=26; idx_out[9]=27; idx_out[10]=28; idx_out[11]=29; idx_out[12]=30; idx_out[13]=31; idx_out[14]=32; idx_out[15]=33; idx_out[16]=34; idx_out[17]=35; end
    default: begin end
    endcase
  end
