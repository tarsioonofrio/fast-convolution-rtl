...
module MatrixC1
  ...
  assign soma[0] =  P[0] - (P[06] + P[12]);
  assign soma[1] =  P[1] - (P[07] + P[13]);
  assign soma[2] =  P[2] - (P[08] + P[14]);
  assign soma[3] =  P[3] - (P[09] + P[15]);
  assign soma[4] =  P[4] - (P[10] + P[16]);
  assign soma[5] =  P[5] - (P[11] + P[17]);

  assign soma[06] =  P[12] - (P[6] + P[18]);
  assign soma[07] =  P[13] - (P[7] + P[19]);
  assign soma[08] =  P[14] - (P[8] + P[20]);
  assign soma[09] =  P[15] - (P[9] + P[21]);
...
module MatrixA1
  ...
  assign soma[3] = P[6] + P[09] + P[10];
  assign soma[4] = P[7] + P[09] + P[11];
