...
package pack_mux_mult;
  parameter int NUM_MULT = 3;
  parameter int STATE_MULT = 12;
endpackage


module MuxMult
  (
    input  logic[$clog2(12-1):0] idx_in, // current state
    output logic[$clog2(12*3-1):0] idx_out[0:3-1]  // index array output
  );
